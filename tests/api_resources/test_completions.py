...
class TestAsyncCompletions:
    ...
    @parametrize
    async def test_method_create_overload_1(self, async_client: AsyncAnthropicBedrock) -> None:
    ...
    @parametrize
    async def test_method_create_with_all_params_overload_1(self, async_client: AsyncAnthropicBedrock) -> None:
        completion = await async_client.completions.create(
            model="anthropic.claude-v2:1",
            max_tokens_to_sample=256,
            prompt="\n\nHuman: Hello, world!\n\nAssistant:",
    ...
    @parametrize
    async def test_raw_response_create_overload_1(self, async_client: AsyncAnthropicBedrock) -> None:
    ...
    @parametrize
    async def test_streaming_response_create_overload_1(self, async_client: AsyncAnthropicBedrock) -> None:
    ...
    @parametrize
    async def test_method_create_overload_2(self, async_client: AsyncAnthropicBedrock) -> None:
    ...
    @parametrize
    async def test_method_create_with_all_params_overload_2(self, async_client: AsyncAnthropicBedrock) -> None:
        completion_stream = await async_client.completions.create(
            model="anthropic.claude-v2:1",
            max_tokens_to_sample=256,
            prompt="\n\nHuman: Hello, world!\n\nAssistant:",
    ...
    @parametrize
    async def test_raw_response_create_overload_2(self, async_client: AsyncAnthropicBedrock) -> None:
        response = await async_client.completions.with_raw_response.create(
            model="anthropic.claude-v2:1",
            max_tokens_to_sample=256,
            prompt="\n\nHuman: Hello, world!\n\nAssistant:",
    ...
    @parametrize
    async def test_streaming_response_create_overload_2(self, async_client: AsyncAnthropicBedrock) -> None:
        async with async_client.completions.with_streaming_response.create(
            model="anthropic.claude-v2:1",
            max_tokens_to_sample=256,
            prompt="\n\nHuman: Hello, world!\n\nAssistant:",

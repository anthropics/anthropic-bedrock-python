...
class TestAnthropicBedrock:
    ...
    def test_copy(self) -> None:
        ...
        copied = self.client.copy(aws_secret_key="another <secret key>")
        assert copied.aws_secret_key == "another <secret key>"
        assert self.client.aws_secret_key == "<secret key>"

        copied = self.client.copy(aws_access_key="another <access key>")
        assert copied.aws_access_key == "another <access key>"
        assert self.client.aws_access_key == "<access key>"

        copied = self.client.copy(aws_region="another us-east-2")
        assert copied.aws_region == "another us-east-2"
        assert self.client.aws_region == "us-east-2"
    ...
    def test_multipart_repeating_array(self, client: AnthropicBedrock) -> None:
        request = client._build_request(
    ...
    def test_base_url_trailing_slash(self, client: AnthropicBedrock) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AnthropicBedrock) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AnthropicBedrock) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/model/anthropic.claude-v2:1/invoke").mock(return_value=httpx.Response(500))
...
class TestAsyncAnthropicBedrock:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncAnthropicBedrock) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncAnthropicBedrock) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncAnthropicBedrock) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncAnthropicBedrock) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
